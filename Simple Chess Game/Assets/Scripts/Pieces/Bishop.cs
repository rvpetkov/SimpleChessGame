...
public class Bishop : ChessPiece
{
    ...
    public override bool[,] GetCheckPositions()
    {
        ...
        {
            if(!BishopCheckMove(++lookUpX, ++lookUpY, ref legalMoves))
                break;
        }
    ...
    public override bool[,] PossibleMoves()
    {
        ...
        while (lookUpX < 7 && lookUpY < 7)
        {
            p = BishopMove(++lookUpX, ++lookUpY, ref result);
            if (p != null)
                break;
        }
    ...
    private ChessPiece BishopMove(int x, int y, ref bool[,] arr)
    {
    ...
    private bool BishopCheckMove(int x, int y, ref bool[,] arr)
    {
        bool result = true;
